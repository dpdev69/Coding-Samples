...
public class PublicTests extends TestCase {
  public void testBasicConstructorsAndGetters() {
    MyDouble a = new MyDouble(5.7), b = newMyDouble(-3.7);
    ...
    assertTrue(z.getReal().compareTo(d) == 0 && z.getInag().compareTo(New MyDouble(0)) == 0);
  }
  ...
  public void testCopyConstructor() {
    ...
    assertTrue(x != y);           // Check to be sure theyh are not aliased!
