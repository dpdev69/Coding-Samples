...
public class Controller {
  ...
  public static int colorScheme;  // Value will be one of the constraints listed above.
  ...
  public static void main(String[] args) {
    new MyDialogBox();  // Display initial dialog box and store values entered by the user.
    ...
    MyComponentListener resizeListnr = new MyComponentListener(View);   // Response to resize request
