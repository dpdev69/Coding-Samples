 ...
 * a typcial entree might be called "Big Bubba Breakfast" and might consist of 
...
public class Entree implements Listable {
  ...
  /**
   * Standard constructor. To enture that the Entree class remains immutable,
   * this constructor will make a copy of the list that foodListIn refers to.
   * (This is necessary because SortedListOfImmutables is mutable.)
   *
