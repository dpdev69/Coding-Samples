...
/* find_board_size - fine height/width of board in list form */
...
/* get_val - return N'th element of the list L, or fail if not found */
...
/* find solutions of board B within N steps */
